...
<head>
    ...
    <title>Company Profile - Desa Penglipuran</title>
</head>
                    ...
                    <div id="site-content" class="site-content clearfix">
                        <div id="inner-content" class="inner-content-wrap">
                            <div class="page-content">
                                ...
                                <div class="container">
                                    <h1 class="text-center my-5">COMPANY PROFILE</h1>
                                    {{-- <center>
                                        <div style="width: 80%; height: 600px;" class="rounded">
                                            <video controls>
                                                <source src="{{ asset('user/video/company-profile.mp4') }}"
                                                    type="video/mp4">
                                                Your browser does not support HTML video.
                                            </video>
                                        </div>
                                    </center> --}}
                                    {{-- <iframe src="https://www.youtube.com/watch?v=7YWOdPh0R9Q&ab_channel=MUSICOLABORASI"
                                        width="100%" height="500px" allowfullscreen="true"
                                        class="rounded"></iframe> --}}
                                    <iframe width="100%" height="500px" src="https://www.youtube.com/embed/7YWOdPh0R9Q"
